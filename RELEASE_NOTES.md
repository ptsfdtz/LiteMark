...
LiteMark 2.1.8 adds signed over-the-air updates and preserves both sidebar states across app restarts.
...
LiteMark 2.1.8 新增了带签名的 OTA 自动更新，并让左右侧边栏都能在重启后恢复状态。
